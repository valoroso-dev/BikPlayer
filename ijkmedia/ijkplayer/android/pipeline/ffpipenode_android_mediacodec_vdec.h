...
#define MEDIACODEC_ERROR_CODE_RPOFILE_UNSUPPORTED       -1
#define MEDIACODEC_ERROR_CODE_CREATE_FORMAT_FAILED      -2
#define MEDIACODEC_ERROR_CODE_NO_SUITABLE_CODEC         -3
#define MEDIACODEC_ERROR_CODE_INVALID_SURFACE           -4
#define MEDIACODEC_ERROR_CODE_CREATE_CODEC_FAILED       -5
#define MEDIACODEC_ERROR_CODE_CONFIGURE_FAILED          -6
#define MEDIACODEC_ERROR_CODE_START_FAILED              -7
