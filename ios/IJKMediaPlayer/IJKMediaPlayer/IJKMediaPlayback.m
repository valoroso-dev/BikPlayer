...
NSString *const IJKMPMoviePlayerStartupInfoNotification = @"IJKMPMoviePlayerStartupInfoNotification";
NSString *const IJKMPMoviePlayerStartupInfoKey = @"IJKMPMoviePlayerStartupInfoKey";
